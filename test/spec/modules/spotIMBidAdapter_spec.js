...
import { spec } from 'modules/spotIMBidAdapter.js';
...
describe('spotIMBidAdapter', function () {
  ...
  describe('buildRequests', function () {
    const bidRequests = [
      {
        'bidder': spec.code,
        'adUnitCode': 'adunit-code',
        'bidId': '430fngf4507356',
        'bidderRequestId': 'fn28573hdy514e',
    ...
    it('should send the correct bid Id', function () {
      const request = spec.buildRequests(bidRequests, bidderRequest);
      expect(request.data.bids[0].bidId).to.equal('430fngf4507356');
    });
